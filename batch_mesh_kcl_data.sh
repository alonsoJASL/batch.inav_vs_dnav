...
# BASE_DIR=$HOME/syncdir/kcl_registration/iNAV
BASE_DIR="/Volumes/sandisk/09-dnav_vs_inav/registration_issue/iNAV"


SEG_NAME_OLD="PVeinsCroppedImage"
SEG_NAME_NEW="PVeinsCroppedImage_new"
MVI_NAME="tx_prodMVI_mra2inav"
...
for n in ${LS_BASE}; do
    ...
    WORK_DIR="$BASE_DIR/$n/CEMRG/iNav"
